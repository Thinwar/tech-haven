  ...
  return (
    <footer className="bg-foreground text-background/70">
      <div className="container py-10 md:py-12">
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-[13px]">
              ...
              <li className="flex items-center gap-2"><Mail className="h-3.5 w-3.5 shrink-0" /> hello@fasttech.co.ke</li>
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-3 border-t border-background/10 pt-6 text-[11px] text-background/30 md:flex-row">
